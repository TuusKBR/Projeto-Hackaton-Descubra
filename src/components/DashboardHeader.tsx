        ...
        <div className="w-full max-w-none px-4 lg:px-8 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          ...
          <div className="flex items-center gap-2 self-start md:self-auto">
            <button 
              ...
              className="px-4 py-1.5 text-xs rounded-xl font-bold transition duration-200 hover:bg-red-800/80 hover:text-red-100 text-red-450 text-red-400 bg-red-950/30 border border-red-900/30 shadow-sm flex items-center gap-1.5 cursor-pointer">
